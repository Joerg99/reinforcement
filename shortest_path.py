...
#SETUP GRAPH RANDOMLY ...
num_nodes = 50
connections = []
for i in range(0,300):
    tup =(np.random.randint(0,num_nodes), np.random.randint(0,num_nodes))
    connections.append(tup)
size_matrices = num_nodes
edges =  connections  

# ... OR BY HAND
# edges = [(0,2),(0,1),(0,3),(2,4),(5,6),(7,4),(0,6),(5,3),(3,7),(0,8)]
